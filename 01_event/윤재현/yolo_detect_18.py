...
class YoloDetectionAlertNode(Node):
    ...
    def detection_loop(self):
        while not self.should_shutdown:
            ...
            # =====================================================================
            # 변경 포인트: conf=0.8 파라미터 추가 (확신도 80% 이상만 탐지)
            # =====================================================================
            results = self.model.predict(img, stream=True, verbose=False, classes=[0], conf=0.8)
            ...
            is_detected = detected_in_range and min_dist < 2.0
...
def main():
    ...
    # CUDA가 명시적으로 설정되어 있습니다. 정상 작동합니다.
