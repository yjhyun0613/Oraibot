#라이다 범위 -90도(왼쪽) ~ 180도(오른쪽) 사이에서 0.5m 이내에 장애물이 감지되면 Nav2의 명령을 무시하고 로봇을 멈추도록 하는 노드입니다.
...
class Robot5SafetyNode(Node):
    def __init__(self):
        ...
        self.stop_distance = 0.3  # 30cm
        
        # 감시 범위: -90도(왼쪽) ~ 180도(오른쪽)
        self.min_angle_rad = math.radians(-90.0)
        self.max_angle_rad = math.radians(180.0)
