...
class HumanSafetyController(Node):
    def __init__(self):
        ...
        self.image_sub = self.create_subscription(Image, '/robot4/oakd/rgb/preview/image_raw', self.image_callback, 10)
        self.depth_sub = self.create_subscription(Image, '/robot4/oakd/stereo/depth/image_raw', self.depth_callback, 10)
        
        # Nav2의 속도 제한 토픽
        self.speed_limit_pub = self.create_publisher(SpeedLimit, '/robot4/speed_limit', 10)
